...
class MLP(object):
    ...
    def __init__(self, rng, input, n_in, n_hidden, n_out, output_layer):
        ...
        self.errors = self.LinearRegression.errors
...
class MLP_OPTIMIZATION(object):
    ...
    def __init__(self, learning_rate, L2_reg, n_epochs, link, batch_size, n_hidden,
                 n_out, output_layer):
        """
    ...
    def __models(self, datasets):
        ...
        cost = classifier.errors(y)  + L2_reg * classifier.L2_sqr
